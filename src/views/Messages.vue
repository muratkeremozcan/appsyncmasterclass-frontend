<template>
  <div id="app" class="flex container h-full w-full">
    <div class="flex container h-full w-full">
      ...
      <div
        class="w-full sm:w-1/3 md:w-1/2 lg:w-1/2 h-full overflow-y-scroll hidden md:block"
      >
        <div
        ...
        <div v-if="!loading">
          ...
          <div
            ...
            :key="conversation.id + conversation.lastMessage"
          >
            <div
              ...
              >
                <div class="flex-none mr-2 md:mr-4 pt-1">
                  <a :href="`#/${conversation.otherUser.screenName}`">
                    <img
                      :src="`${
                        conversation.otherUser.imageUrl || 'default_profile.png'
                      }`"
                ...
                <div class="w-full truncate">
                  <div class="flex items-center w-full">
                    ...
                    <p class="text-sm text-dark ml-auto">
                      {{ conversation.lastModified | timeago }}
                    </p>
                  </div>
...
export default {
  ...
  methods: {
    ...
    sendMessage() {
      if (!this.active.otherUser.id || this.message.length == 0) return
